...
export { getAdvW, getTextWidth, measureTextWrap, pxTruncate, };
 ...
 */
export function getGlassTextInnerWidth(input = G2_TEXT_MAX_WIDTH) {
    if (typeof input === 'number') {
        return Math.max(0, input);
    }
    const { width = G2_TEXT_MAX_WIDTH, paddingX = 0, borderWidth = 0, } = input;
 ...
 */
export function measureGlassText(text, input = G2_TEXT_MAX_WIDTH) {
 ...
 */
export function truncateGlassText(text, input = G2_TEXT_MAX_WIDTH) {
 ...
 */
export function fitsGlassText(text, input = G2_TEXT_MAX_WIDTH) {
