...
export const IcFeatCalendar: SvgIcon = (props) => (
  <svg viewBox="0 0 32 32" fill="none" {...props}>
    <path d="M27 29H5V27H27V29ZM5 9H27V7H29V27H27V11H5V27H3V7H5V9ZM11 23H9V21H11V23ZM17 23H15V21H17V23ZM23 23H21V21H23V23ZM11 17H9V15H11V17ZM17 17H15V15H17V17ZM23 17H21V15H23V17ZM11 5H21V2H23V5H27V7H5V5H9V2H11V5Z" fill="currentColor"/>
  </svg>
);
